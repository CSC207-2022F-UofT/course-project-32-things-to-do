...
Our code coverage document generated by IntelliJ is provided in our repository.
For tests, we prioritized testing our use cases since that was where the bulk of our code went and was the most 
important place for finding logical issues or bugs with our program. We did both unit tests and interactor tests, as well as 
testing for persistent data. 
Our code coverage is a bit lower because our UI, and in some cases controllers and presenters, 
were not tested. The untested portion of our program is indicated in an issue for future work.
