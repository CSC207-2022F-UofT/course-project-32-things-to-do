...
public class CollaborativeTaskEditInteractor implements CollaborativeTaskEditInputBoundary {
     ...
     */
    public CollaborativeTaskEditInteractor(CollaborativeTaskEditPresenter collaborativeTaskPresenter, TaskMapGateway taskMapGateway) {
    ...
    public CollaborativeTaskEditResponseModel edit(CollaborativeTaskEditRequestModel requestModel) {
        ...
        if (!(collaborativeTask.getTeammates().contains(requestModel.getLeader())))  return presenter.prepareFailView("Please enter valid leader.");
        ...
        collaborativeTask.setLeader(requestModel.getLeader());
